      ...
      >
        <div className="footer-top">
          <div className="container">
            ...
            <div className="row">
              <div
                className="col-xl-6 col-lg-4 col-sm-6 wow fadeIn"
                data-wow-duration="2s"
                data-wow-delay="0.2s"
              >
                <div className="widget widget_about">
                  <h3 className="text-primary">Offices</h3>
                  <hr />
                  <p>
                    <b> Bengaluru -</b> No. 45/B, Shubham Complex, 1st A Main,
              ...
              >
                <div className="widget widget_services">
                  <h3 className="text-primary">Our links</h3>
                  <hr />
                  <ul>
                    <li>
                    ...
                    <li>
                      <a href="/media" className="text-black">
                        Media
                      </a>
                    </li>
                    <li>
              ...
              >
                <div className="widget widget_services">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="/minilive-studios" className="text-black">
                        Minilive Studio
                      </a>
                    </li>
                    <li>
                      <a href="/production" className="text-black">
                        Production
                      </a>
                    </li>
                    <li>
                      <a href="/branding" className="text-black">
                        Branding{" "}
                      </a>
                    </li>
                  </ul>
              ...
              <div className="col-sm-12 text-center">
                <p>
                  ...
                  <span className="text-primary">
                    {" "}
                    Intellogic Innovations Pvt Ltd.
                  </span>{" "}
                  All Rights Reserved.{" "}
                </p>
              </div>
