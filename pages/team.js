                ...
                <div className="dlab-team style-1 m-b30">
                  ...
                  <div className="dlab-content">
                    <div className="clearfix">
                      <h4 className="dlab-name">BRIJESH KASHYAP</h4>
                    ...
                    <ul className="dlab-social-icon primary-light">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/brijesh-kashyap-b5a01716/" 
                             className="fa fa-linkedin" target="_blanck"></a>
                        </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="dlab-team style-1 m-b30">
                  ...
                  <div className="dlab-content">
                    <div className="clearfix">
                      ...
                      <span className="dlab-position">Co-Founder</span>
                    </div>
                    <ul className="dlab-social-icon primary-light">
                      {/* <li>
                        <a
