				...
				<div className="banner-inner">
					...
					<div className="col-md-6">
							<div className="dz-media move-box wow fadeIn" data-wow-duration="1.6s" data-wow-delay="0.8s" >
								...
								<img className="move-2" src="images/move/Minilive_home.png" alt=""/>
							</div>
						</div>
						<div className="col-md-6">
							<div className="banner-content">
								...
								<p ><a  data-wow-duration="1.6s" data-wow-delay="2s" className="wow fadeInUp btn btn-link d-inline-flex align-items-center" ><i className="fa fa-download m-r10"></i>Download it from</a></p>
